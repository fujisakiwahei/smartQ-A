...
- 未解決ログの `user_query` を小文字化して同一視し、頻度順に上位10件を表示
- ボタン
  - 「質問コピー」
  - 「Q&A追加へ」（knowledge ページへの導線）

---

## 🏷️ カテゴリ管理仕様（CRUD＋350文字）
...
- ② `TenantAdminShell.vue`（共通UI）
- ③ categories / knowledge（CRUDの基本）
- ④ chat-logs（フィルタ＋詳細）
- ⑤ dashboard（集計＋グラフ）
